...
class appprodUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // fapesc_tutorial_empenho_aluguel
        if (0 === strpos($pathinfo, '/relatorio') && preg_match('#^/relatorio/(?P<idRelatorio>[^/]+?)/empenho/(?P<idEmpenho>[^/]+?)/aluguel$#xs', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Fapesc\\TutorialBundle\\Controller\\EmpenhoController::aluguelAction',)), array('_route' => 'fapesc_tutorial_empenho_aluguel'));
        }

        // fapesc_tutorial_empenho_aluguelpost
        if (0 === strpos($pathinfo, '/relatorio') && preg_match('#^/relatorio/(?P<idRelatorio>[^/]+?)/empenho/(?P<idEmpenho>[^/]+?)/aluguel/post$#xs', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Fapesc\\TutorialBundle\\Controller\\EmpenhoController::aluguelPostAction',)), array('_route' => 'fapesc_tutorial_empenho_aluguelpost'));
        }
        ...
        // fapesc_tutorial_contrapartida_aluguel
        if (0 === strpos($pathinfo, '/relatorio') && preg_match('#^/relatorio/(?P<idRelatorio>[^/]+?)/contrapartida/(?P<idContrapartida>[^/]+?)/aluguel$#xs', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Fapesc\\TutorialBundle\\Controller\\ContrapartidaController::aluguelAction',)), array('_route' => 'fapesc_tutorial_contrapartida_aluguel'));
        }

        // fapesc_tutorial_contrapartida_aluguelpost
        if (0 === strpos($pathinfo, '/relatorio') && preg_match('#^/relatorio/(?P<idRelatorio>[^/]+?)/contrapartida/(?P<idContrapartida>[^/]+?)/aluguel/post$#xs', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Fapesc\\TutorialBundle\\Controller\\ContrapartidaController::aluguelPostAction',)), array('_route' => 'fapesc_tutorial_contrapartida_aluguelpost'));
        }
