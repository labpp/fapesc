...
class __TwigTemplate_0ac6892f81b63548cd0330b6a415e157 extends Twig_Template
{
    protected $parent;
    ...
    {
        echo "Empenho de Recursos - Material de Consumo";
    }
    ...
    <div id=\"main-content\">
        <h1>:: Empenho de Recursos - Material de Consumo</h1>
        ";
        // line 13
        $this->env->loadTemplate("FapescTutorialBundle:Empenho:formEmpenho.html.twig")->display(array_merge($context, array("action" => $this->getContext($context, 'action'))));
        // line 14
...
";
    ...
    {
        return "FapescTutorialBundle:Empenho:material.html.twig";
    }
