...
class __TwigTemplate_45f52a9e461559e20113731d3181c2ce extends Twig_Template
{
...
<form class=\"form-container\" action=\"";
    ...
    <table class=\"form\" width=\"90%\">
        <tr>
            <td width=\"15%\">Unidade:<br /><input type=\"text\" name=\"unidade\" title=\"Informe a unidade de quantificação do serviço (ex: mês, horas, dias, etc).\" value=\"";
        // line 65
        echo twig_escape_filter($this->env, $this->getContext($context, 'unidade'), "html");
        echo "\" /></td>
            <td width=\"5%\">Quantidade:<br /><input type=\"text\" name=\"quantidade\" id=\"quantidade\" class=\"trigger\" title=\"Informe a quantidade de serviços adquiridos.\" value=\"";
        // line 66
        echo twig_escape_filter($this->env, $this->getContext($context, 'quantidade'), "html");
        echo "\"/></td>
            <td width=\"15%\">Valor unitário:<br /><input type=\"text\" name=\"unitario\" id=\"unitario\" class=\"trigger\" title=\"Informe o valor unitário do serviço.\" value=\"";
        // line 67
        echo twig_escape_filter($this->env, $this->getContext($context, 'unitario'), "html");
        echo "\" /></td>
            <td width=\"50%\">Valor total:<br /><input type=\"text\" name=\"total\" id=\"total\" title=\"Informe o valor total do serviço, conforme recibo ou documento fiscal.\" value=\"";
        // line 68
    ...
    {
        return "FapescTutorialBundle:Contrapartida:formContrapartida.html.twig";
    }
