...
<form class=\"form-container\" action=\"";
    ...
    <table class=\"form\">
        <tr>
            <td>Descrição do serviço:<br /><input type=\"text\" name=\"descricao\" title=\"Descrição do serviço a ser empenhado, conforme recibo ou documento fiscal.\" value=\"";
        // line 60
    ...
    <table class=\"form\">
        <tr>
            <td>Unidade:<br /><input type=\"text\" name=\"unidade\" title=\"Informe a unidade de quantificação do serviço (ex: mês, horas, dias, etc).\" value=\"";
        // line 65
        echo twig_escape_filter($this->env, $this->getContext($context, 'unidade'), "html");
        echo "\" /></td>
            <td>Quantidade:<br /><input type=\"text\" name=\"quantidade\" id=\"quantidade\" class=\"trigger\" title=\"Informe a quantidade de serviços adquiridos.\" value=\"";
        // line 66
        echo twig_escape_filter($this->env, $this->getContext($context, 'quantidade'), "html");
        echo "\"/></td>
            <td>Valor unitário:<br /><input type=\"text\" name=\"unitario\" id=\"unitario\" class=\"trigger\" title=\"Informe o valor unitário do serviço.\" value=\"";
        // line 67
        echo twig_escape_filter($this->env, $this->getContext($context, 'unitario'), "html");
        echo "\" /></td>
            <td>Valor total:<br /><input type=\"text\" name=\"total\" id=\"total\" title=\"Informe o valor total do serviço, conforme recibo ou documento fiscal.\" value=\"";
        // line 68
    ...
    <table class=\"form\">
        <tr>
            <td>Documento fiscal / Recibo:<br /><input type=\"text\" name=\"documento\" title=\"Informe o número do recibo ou documento fiscal.\" value=\"";
        // line 73
        echo twig_escape_filter($this->env, $this->getContext($context, 'documento'), "html");
        echo "\"/></td>
            <td>Data de emissão:<br /><input type=\"text\" name=\"data\" id=\"data\" title=\"Informe a data de emissão do recibo ou documento fiscal.\" /></td>
            <td>Comprovante de transação:<br /><input type=\"text\" name=\"comprovante\" title=\"Informe o número do cheque o comprovante eletrônico de transação.\" value=\"";
        // line 75
