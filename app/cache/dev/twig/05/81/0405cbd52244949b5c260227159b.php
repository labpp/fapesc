...
class __TwigTemplate_05810405cbd52244949b5c260227159b extends Twig_Template
{
    protected $parent;
    ...
    {
        echo "Empenho de Recursos - Diária";
    }
...
<div id=\"content\">
    ...
    <div id=\"main-content\">
        ...
        // line 88
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("relatorioEmpenhoDiariaPost", array("idRelatorio" => $this->getContext($context, 'idRelatorio'), "idEmpenho" => $this->getContext($context, 'idEmpenho'))), "html");
        echo "\" method=\"POST\">
            <table class=\"form\">
                <tr>
...
";
    ...
    {
        return "FapescTutorialBundle:Empenho:diaria.html.twig";
    }
