    ...
    <div id=\"main-content\">
        ...
        echo "\" method=\"POST\">
            <table class=\"form\" width=\"90%\">
                <tr>
                    <td width=\"28%\">Projeto:<br />
                        <select name=\"projeto\" title=\"Selecione o projeto aque se refere este relatório.\" style=\"width:500px;\">
                            ";
        // line 45
        ...
        foreach ($context['_seq'] as $context['_key'] => $context['projeto']) {
            // line 46
            echo "                            <option value=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, 'projeto'), "value", array(), "any", false), "html");
            echo "\" ";
            if (($this->getAttribute($this->getContext($context, 'projeto'), "value", array(), "any", false) == $this->getContext($context, 'projeto'))) {
                echo " selected=\"selected\" ";
            }
            echo ">";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, 'projeto'), "text", array(), "any", false), "html");
            echo "</option>
                            ";
        }
        ...
        echo "                        </select>
                    ...
                    <td>Valor NL:<br />R\$ <input type=\"text\" id=\"valor\" name=\"valor\" title=\"Informe o montante total relativo à Nota de Liquidação.\" size=\"20\" value=\"";
        // line 68
        ...
        echo "\" /></td>
            ...
            <table class=\"form\" width=\"90%\">
                <tr>
                    <td width=\"28%\">Tipo de relatório:<br />
                        <select name=\"tipo\" title=\"Selecione o tipo de relatório.\" style=\"width:300px;\">
                            ";
        // line 75
        $context['_parent'] = (array) $context;
