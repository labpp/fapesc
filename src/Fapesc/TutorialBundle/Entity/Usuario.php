...
class Usuario implements UserInterface {
    ...
    /**
     * @var integer $titulacao
     *
     * @ORM\Column(name="titulacao", type="integer")
     */
    protected $titulacao;
    ...
    public function toArray() {
        return array(
            ...
            "titulacoes" => $this->getTitulacoes(),
            "titulacaoSelect" => $this->getTitulacaoSelect(),
            "nome" => $this->getNome(),
    ...
    public function populate($dados) {
        ...
        $this->setTitulacao($dados["titulacao"]);
    ...
    public function getTitulacoes($titulacao = false) {
        $titulacoes = array(
            "1" => "Doutor",
            "2" => "Mestre",
        );
        return $titulacao ? $titulacoes[$titulacao] : $titulacoes;
    }

    public function getTitulacaoSelect() {
        foreach ($this->getTitulacoes() as $key => $value)
            $titulacoes[] = array("value" => $key, "text" => $value);
        return $titulacoes;
    }
